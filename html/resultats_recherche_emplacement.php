    ...
    <main>
        <nav aria-lebel="breadcrumb">
            <ol class="breadcrumb" style="background-color: white;">
                ...
                <li class="breadcrumb-item"><a href="./recherche_emplacement.php">Recherche par emplacement</a></li>
            ...
            <form>
                ...
                <?php
                    ...
                    if (!empty($_GET['ville'])) {
                        ...
                        echo '<br><p class="text-center">Vous n\'avez pas entré de nom de ville!</p>';
                        echo '<br><p class="text-center"><a href="recherche_emplacement.php">Retour</a></p>';
                    }
                ?>
            </form>
